...
5. Edit the README.md file by adding a line below the "### Hi There " line (could be something like- This is a test webpage created as a demo for Github Practice STAT 184).
6. Go to Soumya Mukherjee's GitHub-Practice-184 repo (that generated this page, link https://github.com/Soumya-Mukherjee-stat/GitHub-Practice-184)  
...
7. **Add a row** in your copy of the table below with your information 
...
8. Merge your updated copy of the repo with Soumya Mukherjee's repo...
    ...
    - Click the green button "Create pull request"
    - Job done!
9. (ungraded) pat yourself on the back
