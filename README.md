...
6. **Add a row** in your copy of the table below with your information 
...
7. Merge your updated copy of the repo with Soumya Mukherjee's repo...
    ...
    - Click the green button "Create pull request"
    - Job done!
8. (ungraded) pat yourself on the back
